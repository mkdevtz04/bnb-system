        ...
        <div class="footer-top">
            <div class="footer-brand">
                ...
                <div class="footer-apps">
                    <div class="store-btn-premium"><i class="fab fa-apple"></i><div>Download on the<strong>App Store</strong></div></div>
                    <div class="store-btn-premium"><i class="fab fa-google-play"></i><div>Get it on<strong>Google Play</strong></div></div>
                </div>
            </div>
            ...
            <div class="footer-col">
                ...
                <div class="footer-social">
                    ...
                    <a href="#" class="social-btn-premium"><i class="fab fa-twitter"></i></a>
                    <a href="#" class="social-btn-premium"><i class="fab fa-instagram"></i></a>
                    <a href="#" class="social-btn-premium"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
